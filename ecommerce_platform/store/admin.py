...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'category', 'price', 'stock_quantity', 'rating')
    list_filter = ('rating', 'manufacturer', 'is_active')
...
class CategoryAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request: HttpRequest) -> QuerySet:
        ...
        return queryset.annotate(product_count=Count('category_products', distinct=True))
